...
}(this, function (moment)
{
    ...
    renderTime = function(hh, mm, ss, opts)
    {
        var to_return = '<table cellpadding="0" cellspacing="0" class="pika-time"><tbody><tr>' +
            ...
            renderTimePicker(24, hh, 'pika-select-hour form-select mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm', function(i) {
                if (opts.use24hour) {
                    return i;
                } else {
        ...
        if (opts.showMinutes) {
          to_return += '<td class="px-3">:</td>' +
              renderTimePicker(60, mm, 'pika-select-minute form-select mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm', function(i) { if (i < 10) return "0" + i; return i }, opts.incrementMinuteBy);
        }

        if (opts.showSeconds) {
            to_return += '<td class="px-3">:</td>' +
                renderTimePicker(60, ss, 'pika-select-second form-select mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm', function(i) { if (i < 10) return "0" + i; return i }, opts.incrementSecondBy);
        }
